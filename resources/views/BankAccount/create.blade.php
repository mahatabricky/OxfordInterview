...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Bank Account Create') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('account.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="account_name" value="{{ old('account_name') }}" autofocus>
                                @error('account_name')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="branch" type="text" class="form-control" name="branch" value="{{ old('branch') }}" autofocus>
                                @error('branch')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="account_type" type="number" class="form-control" name="account_type" value="{{ old('account_type') }}" autofocus>
                                @error('account_type')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="swift_code" type="text" class="form-control" name="swift_code" value="{{ old('swift_code') }}" autofocus>
                                @error('swift_code')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="route_no" type="text" class="form-control" name="route_no" value="{{ old('route_no') }}" autofocus>
                                @error('route_no')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
